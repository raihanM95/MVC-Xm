...
namespace MyMVCApp.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult GetStudentDetailsPartial(int studentId)
        {
            var student = _studentManager.GetByStudentId(studentId);

            return PartialView("Student/_StudentView",student);
        }
